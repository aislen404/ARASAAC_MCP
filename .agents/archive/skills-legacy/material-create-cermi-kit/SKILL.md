---
name: material-create-cermi-kit
description: Skill material/create cermi kit para ARASAAC Social MCP Platform. Gates críticos: license, privacy, human_review. Requiere OpenSpec aprobada.
metadata:
  domain: material
...
# skill.material.create_cermi_kit

## Propósito

Ejecutar la capacidad `skill.material.create_cermi_kit` dentro del flujo OpenSpec del proyecto.

## Entradas esperadas

- Contexto de la change OpenSpec activa.
- Artefactos relevantes (`proposal.md`, `design.md`, `tasks.md`, `spec.md`).
- Datos de dominio necesarios para `material/create_cermi_kit`.
