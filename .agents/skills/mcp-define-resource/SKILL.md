---
name: mcp-define-resource
description: Skill mcp/define resource para ARASAAC Social MCP Platform. Requiere OpenSpec aprobada.
metadata:
  domain: mcp
...
Ejecutar la capacidad `skill.mcp.define_resource` dentro del flujo OpenSpec del proyecto.

## Entradas esperadas

- Contexto de la change OpenSpec activa.
- Artefactos relevantes (`proposal.md`, `design.md`, `tasks.md`, `spec.md`).
- Datos de dominio necesarios para `mcp/define_resource`.
