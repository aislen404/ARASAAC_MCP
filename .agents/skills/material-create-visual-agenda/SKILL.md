---
name: material-create-visual-agenda
description: Skill material/create visual agenda para ARASAAC Social MCP Platform. Gates críticos: license, privacy, human_review. Requiere OpenSpec aprobada.
metadata:
  domain: material
...
# skill.material.create_visual_agenda

## Propósito

Ejecutar la capacidad `skill.material.create_visual_agenda` dentro del flujo OpenSpec del proyecto.

## Entradas esperadas

- Contexto de la change OpenSpec activa.
- Artefactos relevantes (`proposal.md`, `design.md`, `tasks.md`, `spec.md`).
- Datos de dominio necesarios para `material/create_visual_agenda`.
