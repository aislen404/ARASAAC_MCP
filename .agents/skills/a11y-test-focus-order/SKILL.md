---
name: a11y-test-focus-order
description: Skill a11y/test focus order para ARASAAC Social MCP Platform. Requiere OpenSpec aprobada.
metadata:
  domain: a11y
...
Ejecutar la capacidad `skill.a11y.test_focus_order` dentro del flujo OpenSpec del proyecto.

## Entradas esperadas

- Contexto de la change OpenSpec activa.
- Artefactos relevantes (`proposal.md`, `design.md`, `tasks.md`, `spec.md`).
- Datos de dominio necesarios para `a11y/test_focus_order`.
