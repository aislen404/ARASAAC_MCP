---
name: mcp-validate-tool-security
description: Skill mcp/validate tool security para ARASAAC Social MCP Platform. Requiere OpenSpec aprobada.
metadata:
  domain: mcp
...
Ejecutar la capacidad `skill.mcp.validate_tool_security` dentro del flujo OpenSpec del proyecto.

## Entradas esperadas

- Contexto de la change OpenSpec activa.
- Artefactos relevantes (`proposal.md`, `design.md`, `tasks.md`, `spec.md`).
- Datos de dominio necesarios para `mcp/validate_tool_security`.
